/* =====================================================
   PORTFOLIO CONTENT
   Edit this file to add, remove, or update projects — no
   build step needed, just refresh the browser (npm run dev).

   To add a new project: push a new object to the PROJECTS array.
   ...
   Note on trusted HTML: `bullets` and subItem `content` entries are inserted
   as raw HTML (not escaped) by js/main.js's buildCard(), so inline tags like
   <strong>/<em> work — but never put untrusted input in them. Every other
   field (title, subtitle, org, period, tags, link labels) IS escaped.
   ===================================================== */
