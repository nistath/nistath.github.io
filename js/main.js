...
/* Pinned repo list comes from content/site.yaml via the SITE_CONTENT
   inline script that the build injects into index.html. */
...
/* =====================================================
   PORTFOLIO
   =====================================================
   Cards are baked into index.html at build time from
   content/portfolio.yaml (see build/templates/portfolio.js).
   Only the expand/collapse behavior lives here. */
